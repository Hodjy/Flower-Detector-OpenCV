...
negativeTemplateNewSize = (150,150)
...
def Preprocess():
    ...
    __preprocessImages(NTemplateList, FilePathForProcessedNTemplates + mediumPath, (negativeTemplateNewSize[0] // 2, negativeTemplateNewSize[1] // 2))
    __preprocessImages(NTemplateList, FilePathForProcessedNTemplates + smallPath, (negativeTemplateNewSize[0] // 4, negativeTemplateNewSize[1] // 4))
